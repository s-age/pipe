...
import { turnStyle, turnHeader, turnHeaderInfo, turnIndexStyle, turnTimestamp, turnHeaderControls, turnContent, rawMarkdown, renderedMarkdown, toolResponseContent, statusSuccess, statusError, editablePre, editTextArea, editButtonContainer } from './Turn.css';
...
const Turn: React.FC<TurnProps> = ({ turn, index, sessionId, expertMode, onDeleteTurn, onForkSession }) => {
  ...
  return (
    <div className={turnStyle} id={`turn-${index}`}>
