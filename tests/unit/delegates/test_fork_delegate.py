...
class TestForkDelegate(unittest.TestCase):
    ...
    def test_run_fork_success(self):
        ...
        self.mock_session_service.fork_session.assert_called_once_with("session-to-fork", 2)
    ...
    def test_run_fork_handles_service_errors(self):
        ...
        self.mock_session_service.fork_session.side_effect = FileNotFoundError("Session not found")
