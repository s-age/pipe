...
class TestGeminiCliIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        settings_data = {
            "model": "gemini-test-model", "search_model": "gemini-test-model", "context_limit": 10000,
            "api_mode": "gemini-cli", "language": "en", "yolo": True, "expert_mode": False, "timezone": "UTC",
            "parameters": {
